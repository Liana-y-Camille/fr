...
">
  <p style="font-size: 1.2em;">
    Le plus beau cadeau sera de vous avoir avec nous pour notre mariage ! Si vous souhaitez nous soutenir pour ce nouveau chapitre de notre vie, veuillez suivre le lien ci-dessous.
  </p>
</div>
...
<div style="display: flex; flex-direction: column; gap: 20px; max-width: 500px; margin: 40px auto;">
  ...
  " onmouseover="this.style.transform='scale(1.03)';this.style.boxShadow='0 6px 10px rgba(0,0,0,0.1)'" 
    ...
    <strong style="font-size: 1.4em;">Liste de Mariage Zola</strong>
  </a>
