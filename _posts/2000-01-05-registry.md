...
">
  <p style="font-size: 1.2em;">
    Le plus beau cadeau sera de vous avoir avec nous pour notre mariage ! Comme notre vie est rythmée par les voyages et les changements, nous serions reconnaissants de recevoir pricipalement des cadeaux monétaires, afin de nous aider à créer de nouveaux souvenirs où que la vie nous mène!
  </p>
</div>
...
<div style="display: flex; flex-direction: column; gap: 20px; max-width: 500px; margin: 40px auto;">
  ...
  " onmouseover="this.style.transform='scale(1.03)';this.style.boxShadow='0 6px 10px rgba(0,0,0,0.1)'" 
    ...
    <strong style="font-size: 1.4em;">Pórtico Real</strong>
  </a>
